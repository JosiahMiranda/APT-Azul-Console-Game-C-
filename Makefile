...
all: GameEngineIO.o GameEngineCallback.o GameEngine.o Player.o AI.o MosaicStorage.o Mosaic.o BrokenTiles.o Factory.o Tile.o Node.o LinkedList.o Input.o Menu.o main.o assign2
...
AI.o: ./Player/AI.cpp
	g++ -Wall -Werror -std=c++14 -g -O -c ./Player/AI.cpp
...
assign2: 
	g++ -Wall -Werror -std=c++14 -g -O -o assign2 GameEngineIO.o GameEngineCallback.o GameEngine.o Player.o AI.o MosaicStorage.o Mosaic.o BrokenTiles.o Factory.o Tile.o Node.o LinkedList.o Input.o Menu.o main.o
